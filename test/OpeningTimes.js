...
describe('OpeningTimes', () => {
  ...
  describe('getOpeningHoursMessage()', () => {
    ...
    const openingTimes = new OpeningTimes(openingTimesJson, 'Europe/London');
    it('when currently open and closing this evening should return pm today open message', () => {
    ...
    it('when currently open and closing time is midnight should return midnight message', () => {
